...
# def initialize(builder, module, definations, function_def):
#     global globalTrue, globalFalse, function_definations, functions
...
#         pg = Parser(self.module, self.builder, self.printf, function_definations, functions)
#         pg.parse()
...
#         return self.builder.call(functions[self.name], evaluatedlist)
...
# class Parser():
#     def __init__(self, module, builder, printf, definations = {}, functions = {}):
...
#         initialize(builder, module, definations, functions)
